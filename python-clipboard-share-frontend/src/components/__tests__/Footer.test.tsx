...
describe("Footer", () => {
  ...
  it("displays the terminal prompt", () => {
    ...
    expect(screen.getByText("python@clipboard:~$")).toBeInTheDocument();
  });
  ...
  it("has responsive layout with flexbox", () => {
    ...
    const contentDiv = screen.getByText("python@clipboard:~$").closest("div");
  ...
  it("has neon green color for terminal prompt", () => {
    ...
    const terminalPrompt = screen.getByText("python@clipboard:~$");
