...
describe("Auth Utils", () => {
  ...
  describe("saveApiKey", () => {
    it("should save API key to localStorage", () => {
      ...
      expect(localStorage.getItem("python_clipboard_share_api_key")).toBe(
        apiKey,
      );
    });
  ...
  describe("getApiKey", () => {
    it("should return API key from localStorage", () => {
      const apiKey = "test-api-key-123";
      localStorage.setItem("python_clipboard_share_api_key", apiKey);
  ...
  describe("removeApiKey", () => {
    it("should remove API key from localStorage", () => {
      ...
      expect(localStorage.getItem("python_clipboard_share_api_key")).toBeNull();
    });
  ...
  describe("isAuthenticated", () => {
    it("should return true when API key exists", () => {
      localStorage.setItem("python_clipboard_share_api_key", "test-key");
